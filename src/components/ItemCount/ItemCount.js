...
export default function Counter({number, increment, decrement, agregar}){
        ...
        <div className="card text-center align-self-center" style={{maxWidth: '500px'}} >
            ...
            <div className="col-sm-7">
              <div className="card-body">
                   ...
                   <div className='' >
                   {
                            number > 5 ? <p className="noStock">stock insuficiente</p> : 
                            <p className="align-self-center">Cantidad: {number}</p>
                        }

                        {
                            number > 5 ? <button className="btn btn-success btn-xs mr-4" onClick={increment} disabled>+</button> :
                            <button className="btn btn-success btn-xs mr-4" onClick={increment}>+</button>
                        }
